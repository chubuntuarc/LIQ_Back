...
EXECUTE [dbo].[PG_CF_PARAMETRO]			0, 0,
										102, 'VIGENCIA CONTRASE�A',	'PWD', 10, 'PARAMETRO = @PP_DIAS_VIGENCIA', 1 
GO

EXECUTE [dbo].[PG_CF_VALOR_PARAMETRO]	0, 0, 0,
										1020, 'VIGENCIA CONTRASE�A', '(PP_DIAS_VIGENCIA=ENTERO_1)',
										0, 102, 
										'TXT_1', 'TXT_2', 'TXT_3', 
										90, -1, -1, 
										-1, -1, -1 
...
AS
	...
	EXECUTE [dbo].[PG_SK_SISTEMA_VALIDAR_GET]	@PP_L_DEBUG, @PP_K_SISTEMA_EXE,
												@OU_SISTEMA_OK = @VP_SISTEMA_OK		OUTPUT
	-- ======================
	-- EXECUTE PG_CF_PARAMETRO 102, 'VIGENCIA CONTRASE�A',	'PWD', 10, 'PARAMETRO = @PP_DIAS_VIGENCIA', 1 
...
EXECUTE [dbo].[PG_CF_PARAMETRO]			0, 0,
										103, 'DEFAULT CONTRASE�A',	'PWD', 10, 'PARAMETRO = @PP_DEFAULT_PASSWORD', 1 
GO

EXECUTE [dbo].[PG_CF_VALOR_PARAMETRO]	0, 0, 0,
										1030, 'DEFAULT CONTRASE�A', '',
										0, 103, 
										'123456', 'TXT_2', 'TXT_3', 
										-1, -1, -1, 
										-1, -1, -1 
...
AS
	...
	EXECUTE [dbo].[PG_SK_SISTEMA_VALIDAR_GET]	@PP_L_DEBUG, @PP_K_SISTEMA_EXE,
												@OU_SISTEMA_OK = @VP_SISTEMA_OK		OUTPUT
	-- ======================
	-- EXECUTE PG_CF_PARAMETRO 103, 'DEFAULT CONTRASE�A','PWD', 10, 'PARAMETRO = @PP_DEFAULT_PASSWORD', 1 
