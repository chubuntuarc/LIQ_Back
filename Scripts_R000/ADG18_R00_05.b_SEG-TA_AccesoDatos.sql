...
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[PG_CF_DATA_SISTEMA]') AND type in (N'P', N'PC'))
	DROP PROCEDURE [dbo].[PG_CF_DATA_SISTEMA]
GO



CREATE PROCEDURE [dbo].[PG_CF_DATA_SISTEMA]
	@PP_L_DEBUG					INT,
...
EXECUTE [dbo].[PG_CF_DATA_SISTEMA]	0, 0, 01, 'EMPRESA',				'', 10, '', 1
EXECUTE [dbo].[PG_CF_DATA_SISTEMA]	0, 0, 02, 'PLANTA',					'', 20, '', 1
EXECUTE [dbo].[PG_CF_DATA_SISTEMA]	0, 0, 03, 'CLIENTE',				'', 30, '', 1
EXECUTE [dbo].[PG_CF_DATA_SISTEMA]	0, 0, 04, 'SOLICITUD',				'', 10, '', 1
EXECUTE [dbo].[PG_CF_DATA_SISTEMA]	0, 0, 05, 'SIMULACION',				'', 20, '', 1
EXECUTE [dbo].[PG_CF_DATA_SISTEMA]	0, 0, 06, 'TABLA_AMORTIZACION',		'', 10, '', 1
EXECUTE [dbo].[PG_CF_DATA_SISTEMA]	0, 0, 07, 'DOCUMENTO_SOLICITUD',	'', 30, '', 1
EXECUTE [dbo].[PG_CF_DATA_SISTEMA]	0, 0, 08, 'MOVIMIENTO_BANCO',		'', 20, '', 1
EXECUTE [dbo].[PG_CF_DATA_SISTEMA]	0, 0, 09, 'MOVIMIENTO_PRESTAMO',	'', 30, '', 1
EXECUTE [dbo].[PG_CF_DATA_SISTEMA]	0, 0, 10, 'DOCUMENTOS',				'', 10, '', 1 
EXECUTE [dbo].[PG_CF_DATA_SISTEMA]	0, 0, 11, 'CUENTA_BANCO',			'', 20, '', 1 
EXECUTE [dbo].[PG_CF_DATA_SISTEMA]	0, 0, 12, 'CONTRATO',				'', 30, '', 1 
EXECUTE [dbo].[PG_CF_DATA_SISTEMA]	0, 0, 13, 'SECCION_REDACCION',		'', 10, '', 1 
EXECUTE [dbo].[PG_CF_DATA_SISTEMA]	0, 0, 14, 'CONTRATO_SOLICITUD',		'', 20, '', 1 
EXECUTE [dbo].[PG_CF_DATA_SISTEMA]	0, 0, 15, 'ENTREGA_RECURSO',		'', 30, '', 1 
...
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[PG_CF_DATA_OPERACION]') AND type in (N'P', N'PC'))
	DROP PROCEDURE [dbo].[PG_CF_DATA_OPERACION]
GO



CREATE PROCEDURE [dbo].[PG_CF_DATA_OPERACION]
	@PP_L_DEBUG					INT,
	@PP_K_SISTEMA_EXE			INT,
...
EXECUTE [dbo].[PG_CF_DATA_OPERACION]	0, 0, 01, 'LISTADO',		'LI', 10, '', 1
EXECUTE [dbo].[PG_CF_DATA_OPERACION]	0, 0, 02, 'FICHA',			'SK', 20, '', 1
EXECUTE [dbo].[PG_CF_DATA_OPERACION]	0, 0, 03, 'INSERTAR',		'IN', 30, '', 1
EXECUTE [dbo].[PG_CF_DATA_OPERACION]	0, 0, 04, 'ACTUALIZAR',		'UP', 30, '', 1
EXECUTE [dbo].[PG_CF_DATA_OPERACION]	0, 0, 05, 'BORRAR',			'DL', 30, '', 1
GO
...
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[PG_CF_DATA_PERFIL]') AND type in (N'P', N'PC'))
	DROP PROCEDURE [dbo].[PG_CF_DATA_PERFIL]
GO



CREATE PROCEDURE [dbo].[PG_CF_DATA_PERFIL]
	@PP_L_DEBUG					INT,
	@PP_K_SISTEMA_EXE			INT,
...
EXECUTE [dbo].[PG_CF_DATA_PERFIL]	0, 0, 00, 'TI/MASTER',		'TI', 99, 'FULL', 1
EXECUTE [dbo].[PG_CF_DATA_PERFIL]	0, 0, 01, 'CONSULTA',		'CONS', 10, 'LI/SK', 1
EXECUTE [dbo].[PG_CF_DATA_PERFIL]	0, 0, 02, 'OPERACION',		'OPER', 20, 'LI/SK/IN/UP', 1
EXECUTE [dbo].[PG_CF_DATA_PERFIL]	0, 0, 03, 'ADMINISTRACION',	'ADMN', 30, 'LI/SK/IN/UP/DL', 1
GO
...
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[PG_CF_USUARIO_DATA_PERFIL]') AND type in (N'P', N'PC'))
	DROP PROCEDURE [dbo].[PG_CF_USUARIO_DATA_PERFIL]
GO



CREATE PROCEDURE [dbo].[PG_CF_USUARIO_DATA_PERFIL]
	@PP_K_USUARIO			INT,
	@PP_K_DATA_PERFIL		INT	
AS
...
EXECUTE [dbo].[PG_CF_USUARIO_DATA_PERFIL]	69, 0
