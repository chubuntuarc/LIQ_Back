...
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[PG_CB_TABLA_N1_X_ORDEN_Load]') AND type in (N'P', N'PC'))
	DROP PROCEDURE [dbo].[PG_CB_TABLA_N1_X_ORDEN_Load]
GO


CREATE PROCEDURE [dbo].[PG_CB_TABLA_N1_X_ORDEN_Load]
	@PP_L_DEBUG					INT,
	@PP_K_SISTEMA_EXE			INT,
