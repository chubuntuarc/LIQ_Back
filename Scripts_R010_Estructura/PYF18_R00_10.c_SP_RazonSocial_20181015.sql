...
AS			
	...
	IF @VP_MENSAJE<>''
		...
		SET		@VP_MENSAJE = 'No es posible [Crear] la [Raz�n Social]: ' + @VP_MENSAJE 
...
AS			
	...
	IF @VP_MENSAJE<>''
		...
		SET		@VP_MENSAJE = 'No es posible [Actualizar] la [Raz�n Social]: ' + @VP_MENSAJE 
		SET		@VP_MENSAJE = @VP_MENSAJE + ' ( '
...
AS
	...
	IF @VP_MENSAJE<>''
		...
		SET		@VP_MENSAJE = 'No es posible [Borrar] la [Raz�n Social]: ' + @VP_MENSAJE 
		SET		@VP_MENSAJE = @VP_MENSAJE + ' ( '
		SET		@VP_MENSAJE = @VP_MENSAJE + '[#RZS.'+CONVERT(VARCHAR(10),@PP_K_RAZON_SOCIAL)+']'
		SET		@VP_MENSAJE = @VP_MENSAJE + ' )'
