...
EXECUTE [dbo].[PG_CI_SUBMENU] 0, 0,  1, 1, 'PRUEBA',			'PRU', 1, '', 1, 'Pruebas'
EXECUTE [dbo].[PG_CI_SUBMENU] 0, 0,  2, 1, 'PRELIQUIDACION',	'PRE', 1, '', 1, 'Preliquidaciones'
EXECUTE [dbo].[PG_CI_SUBMENU] 0, 0,  3, 1, 'PUNTO_VENTA',		'PDV', 1, '', 1, 'Puntos de venta'
EXECUTE [dbo].[PG_CI_SUBMENU] 0, 0,  4, 2, 'SUB_1',				'SU1', 1, '', 1, 'SUB2_1'
EXECUTE [dbo].[PG_CI_SUBMENU] 0, 0,  5, 2, 'SUB_2',				'SU2', 1, '', 1, 'SUB2_2'
GO
