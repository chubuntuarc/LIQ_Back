...
CREATE TABLE [dbo].[DETALLE_PRELIQUIDACION] (
	...
	[D_DETALLE_PRELIQUIDACION]		[VARCHAR](100)	NOT NULL,
	[S_DETALLE_PRELIQUIDACION]		[VARCHAR](10)	NOT NULL,
	[O_DETALLE_PRELIQUIDACION]		[INT]			NOT NULL,
	[L_DETALLE_PRELIQUIDACION]		[INT]			NOT NULL,
	[F_DETALLE_PRELIQUIDACION]		[DATE]			NOT NULL,
	-- ============================	
