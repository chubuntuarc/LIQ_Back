...
-- EXEC [dbo].[PG_LI_PRELIQUIDACION] 0,0,0,'',-1,-1
...
AS
	...
	AND		(	PRELIQUIDACION.S_PRELIQUIDACION		LIKE '%'+@PP_BUSCAR+'%'
			...
			OR	D_TIPO_PRELIQUIDACION				LIKE '%'+@PP_BUSCAR+'%' 
...
AS
	...
	SELECT  @VP_K_TIPO_PRELIQUIDACION = PRELIQUIDACION.K_TIPO_PRELIQUIDACION
			FROM	PRELIQUIDACION
...
--EXEC [dbo].[PG_IN_PRELIQUIDACION] 000,,,,
...
CREATE PROCEDURE [dbo].[PG_IN_PRELIQUIDACION]
	...
	@PP_TANQUE_10_INICIAL		INT,
	@PP_TANQUE_10_FINAL			INT,
	@PP_TANQUE_20_INICIAL		INT,
	@PP_TANQUE_20_FINAL			INT,
	@PP_TANQUE_27_INICIAL		INT,
	@PP_TANQUE_27_FINAL			INT,
	@PP_TANQUE_30_INICIAL		INT,
	@PP_TANQUE_30_FINAL			INT,
	@PP_TANQUE_45_INICIAL		INT,
	@PP_TANQUE_45_FINAL			INT
	-- ============================
AS
...
IF @VP_MENSAJE=''
	...
	INSERT INTO PRELIQUIDACION
			...
			-- ===========================
			[PESO_INICIAL], [PESO_FINAL], [NIVEL_INICIAL], [NIVEL_FINAL], 
			[LECTURA_INICIAL], [LECTURA_FINAL], [CARBURACION_INICIAL], [CARBURACION_FINAL], 
			[TANQUE_10_INICIAL], [TANQUE_10_FINAL], [TANQUE_20_INICIAL], [TANQUE_20_FINAL], 
			[TANQUE_27_INICIAL], [TANQUE_27_FINAL], [TANQUE_30_INICIAL], [TANQUE_30_FINAL], 
			[TANQUE_45_INICIAL], [TANQUE_45_FINAL], 
			-- ===========================
			[K_USUARIO_ALTA], [F_ALTA], [K_USUARIO_CAMBIO], [F_CAMBIO],
			[L_BORRADO], [K_USUARIO_BAJA], [F_BAJA] )
	VALUES
			( @VP_K_PRELIQUIDACION,
			@PP_D_PRELIQUIDACION, @PP_S_PRELIQUIDACION, @PP_O_PRELIQUIDACION, @PP_L_PRELIQUIDACION, @PP_F_PRELIQUIDACION,
			-- ===========================
			@PP_K_ESTATUS_PRELIQUIDACION, @PP_K_TIPO_PRELIQUIDACION, @PP_K_PUNTO_VENTA,
			-- ===========================
			@PP_PESO_INICIAL, @PP_PESO_FINAL, @PP_CARBURACION_INICIAL, @PP_CARBURACION_FINAL, 
			@PP_LECTURA_INICIAL, @PP_LECTURA_FINAL, @PP_CARBURACION_INICIAL, @PP_CARBURACION_FINAL,
			@PP_TANQUE_10_INICIAL, @PP_TANQUE_10_FINAL, @PP_TANQUE_20_INICIAL, @PP_TANQUE_20_FINAL, 
			@PP_TANQUE_27_INICIAL, @PP_TANQUE_27_FINAL, @PP_TANQUE_30_INICIAL, @PP_TANQUE_30_FINAL, 
			@PP_TANQUE_45_INICIAL, @PP_TANQUE_45_FINAL, 
			-- ===========================
...
AS			
	...
	IF @VP_MENSAJE=''
		...
		SET			
				...
				[TANQUE_10_INICIAL]			= @PP_TANQUE_10_INICIAL,
				[TANQUE_10_FINAL]			= @PP_TANQUE_10_FINAL,
				[TANQUE_20_INICIAL]			= @PP_TANQUE_20_INICIAL,
				[TANQUE_20_FINAL]			= @PP_TANQUE_20_FINAL,
				[TANQUE_27_INICIAL]			= @PP_TANQUE_27_INICIAL,
				[TANQUE_27_FINAL]			= @PP_TANQUE_27_FINAL,
				[TANQUE_30_INICIAL]			= @PP_TANQUE_30_INICIAL,
				[TANQUE_30_FINAL]			= @PP_TANQUE_30_FINAL,
				[TANQUE_45_INICIAL]			= @PP_TANQUE_45_INICIAL,
				[TANQUE_45_FINAL]			= @PP_TANQUE_45_FINAL,
				-- ===========================
			    [F_CAMBIO]				= GETDATE(), 
