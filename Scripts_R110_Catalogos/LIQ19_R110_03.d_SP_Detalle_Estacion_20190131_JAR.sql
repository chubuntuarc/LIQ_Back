-- //////////////////////////////////////////////////////////////
-- // ARCHIVO:			LIQ19_R100_01.d_SP_DETALLE_ESTACION_CARBURACION
-- //////////////////////////////////////////////////////////////
...
CREATE PROCEDURE [dbo].[PG_LI_DETALLE_ESTACION_CARBURACION]
	@PP_L_DEBUG						INT,
...
AS
	...
	FROM	DETALLE_ESTACION_CARBURACION, USUARIO
			-- ==============================
...
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[PG_IN_DETALLE_ESTACION_CARBURACION]') AND type in (N'P', N'PC'))
	DROP PROCEDURE [dbo].[PG_IN_DETALLE_ESTACION_CARBURACION]
GO

-- EXEC [dbo].[PG_IN_DETALLE_ESTACION_CARBURACION] 0,0,0,'TEST POS','TEST', '', 0, 1, 1,'JUAREZ', 0, 1000, '', 'TEST123', 'FORD', '2019', 0.0000, 'AFHSYTD1876', 8000, '90', 'LITROMETRO', 'GASPAR G4S'

CREATE PROCEDURE [dbo].[PG_IN_DETALLE_ESTACION_CARBURACION]
	@PP_L_DEBUG					INT,
	@PP_K_SISTEMA_EXE			INT,
	@PP_K_USUARIO_ACCION		INT,
	-- ===========================			
...
AS			
	...
	DECLARE @VP_K_DETALLE_ESTACION_CARBURACION	INT = 0
	DECLARE @VP_O_DETALLE_ESTACION_CARBURACION	INT = 0
	
	IF @VP_MENSAJE=''	
		EXECUTE [dbo].[PG_RN_DETALLE_ESTACION_CARBURACION_INSERT]	@PP_L_DEBUG, @PP_K_SISTEMA_EXE, @PP_K_USUARIO_ACCION,
												--	@VP_K_DETALLE_ESTACION_CARBURACION, 
													@OU_RESULTADO_VALIDACION = @VP_MENSAJE		OUTPUT
	...
	IF @VP_MENSAJE=''
		...
		EXECUTE [dbo].[PG_SK_CATALOGO_K_MAX_GET]	@PP_L_DEBUG, @PP_K_SISTEMA_EXE, 
													'DETALLE_ESTACION_CARBURACION', 
													@OU_K_TABLA_DISPONIBLE = @VP_K_DETALLE_ESTACION_CARBURACION	OUTPUT
		-- ====================================

		INSERT INTO DETALLE_ESTACION_CARBURACION
			( [K_DETALLE_ESTACION_CARBURACION],
			-- ===========================
			[K_PUNTO_VENTA],
			-- ===========================
	...
	IF @VP_MENSAJE<>''
		...
		SET		@VP_MENSAJE = 'No es posible [Crear] el [DETALLE_ESTACION_CARBURACION]: ' + @VP_MENSAJE 
		SET		@VP_MENSAJE = @VP_MENSAJE + ' ( '
		SET		@VP_MENSAJE = @VP_MENSAJE + '[#PDV.'+CONVERT(VARCHAR(10),@VP_K_DETALLE_ESTACION_CARBURACION)+']'
		SET		@VP_MENSAJE = @VP_MENSAJE + ' )'
	
		END
	
	SELECT	@VP_MENSAJE AS MENSAJE, @VP_K_DETALLE_ESTACION_CARBURACION AS CLAVE
...
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[PG_UP_DETALLE_ESTACION_CARBURACION]') AND type in (N'P', N'PC'))
	DROP PROCEDURE [dbo].[PG_UP_DETALLE_ESTACION_CARBURACION]
GO

CREATE PROCEDURE [dbo].[PG_UP_DETALLE_ESTACION_CARBURACION]
	@PP_L_DEBUG							INT,
	@PP_K_SISTEMA_EXE					INT,
	@PP_K_USUARIO_ACCION				INT,
	-- ===========================			
...
AS			
	...
	IF @VP_MENSAJE=''
		EXECUTE [dbo].[PG_RN_DETALLE_ESTACION_CARBURACION_UPDATE]	@PP_L_DEBUG, @PP_K_SISTEMA_EXE, @PP_K_USUARIO_ACCION,
	...
	IF @VP_MENSAJE=''
		BEGIN
		-- ===========================
		UPDATE	DETALLE_ESTACION_CARBURACION
		SET			
		...
		WHERE	K_DETALLE_ESTACION_CARBURACION=@PP_K_DETALLE_ESTACION_CARBURACION
	...
	IF @VP_MENSAJE<>''
		...
		SET		@VP_MENSAJE = 'No es posible [Actualizar] el [DETALLE_ESTACION_CARBURACION]: ' + @VP_MENSAJE 
		SET		@VP_MENSAJE = @VP_MENSAJE + ' ( '
	...
	SELECT	@VP_MENSAJE AS MENSAJE, @PP_K_DETALLE_ESTACION_CARBURACION AS CLAVE
