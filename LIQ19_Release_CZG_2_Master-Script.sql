...
-- // SERVIDOR:			
-- //////////////////////////////////////////////////////////////
-- // BASE DE DATOS:	LIQ19_Crédito_y_Cobranza
-- // MÓDULO:			CREACIÓN DE BASE DE DATOS 
-- //					  -INCLUYE TABLAS
-- //					  -STORED PROCEDURES
-- //					  -CARGA INICIAL
-- //					  -DATOS DE PRUEBA
-- // OPERACIÓN:		LIBERACIÓN (CARPETA COMPLETA)
-- //////////////////////////////////////////////////////////////
-- //////////////////////////////////////////////////////////////
-- //////////////////////////////////////////////////////////////
...
/****************************************************************/
/*				EJECUCIÓN DE CARPETA DE LIBERACIÓN				*/
/****************************************************************/
...
SET @VP_SQL_SERVIDOR	= 'DESKTOP-TFN0OJL\CZAMARRON'
SET @VP_SQL_USER		= 'sa'
...
SET @VP_STR_RUTA_PROYECTO		= 'C:\PROYECTOS_TOMZA_23072018\'
SET @VP_STR_RUTA_CONSTRUCCION	= 'LIQ19_Liquidaciones\LIQ19_SQL\LIQ19_Liberacion_R0.00_Base_V0006\'
...
-- ========================================
		...
		INSERT INTO @VP_TBL_SQLFolders VALUES ('Scripts_R000_Infra\')
	INSERT INTO @VP_TBL_SQLFolders VALUES ('Scripts_R001_Tiempo\')
	INSERT INTO @VP_TBL_SQLFolders VALUES ('Scripts_R005_Seguridad\')
	-- ========================================
	...
	INSERT INTO @VP_TBL_SQLFolders VALUES ('Scripts_R200_Reportes\')
	INSERT INTO @VP_TBL_SQLFolders VALUES ('Scripts_R900_Permisos\')
...
WHILE @@FETCH_STATUS = 0
    ...
    WHILE @@FETCH_STATUS = 0
		...
		PRINT '>   CONSTRUCCIÓN: ' + @VP_STR_RUTA_CONSTRUCCION
