...
-- EXEC [dbo].[PG_LI_PUNTO_VENTA] 0,0,0,'',-1,3,-1
...
AS
	...
	TABLE
			(K_FICHA_ESTACION_CARBURACION		INT,
			 K_PUNTO_VENTA_ESTACION				INT,
			 LECTURA_INICIAL_ESTACION			INT,
			 LECTURA_FINAL_ESTACION				INT,
			 DIRECCION							VARCHAR(100),
			 CAPACIDAD_ESTACION					INT,
			 PORCENTAJE_ESTACION				VARCHAR(100),
			 D_MEDIDOR							VARCHAR(100),
			 D_TIPO_MEDIDOR						VARCHAR(100) )

	INSERT INTO @VP_TBL_FICHA_ESTACION_CARBURACION
			(K_FICHA_ESTACION_CARBURACION, K_PUNTO_VENTA_ESTACION, LECTURA_INICIAL_ESTACION, LECTURA_FINAL_ESTACION, DIRECCION,
			 CAPACIDAD_ESTACION, PORCENTAJE_ESTACION, D_MEDIDOR, D_TIPO_MEDIDOR )
	SELECT	K_FICHA_ESTACION_CARBURACION, FICHA_ESTACION_CARBURACION.K_PUNTO_VENTA, LECTURA_INICIAL, LECTURA_FINAL, DIRECCION,
			CAPACIDAD, PORCENTAJE, D_MEDIDOR, D_TIPO_MEDIDOR
	FROM	FICHA_ESTACION_CARBURACION , PUNTO_VENTA, MEDIDOR, TIPO_MEDIDOR
	WHERE	FICHA_ESTACION_CARBURACION.K_PUNTO_VENTA=PUNTO_VENTA.K_PUNTO_VENTA
	AND		MEDIDOR.K_MEDIDOR=FICHA_ESTACION_CARBURACION.K_MEDIDOR
	AND		TIPO_MEDIDOR.K_TIPO_MEDIDOR=FICHA_ESTACION_CARBURACION.K_TIPO_MEDIDOR

	-- ========================================= TABLA TEMPORAL FICHA PORTATIL
	DECLARE @VP_TBL_FICHA_PORTATIL
	TABLE
			(K_FICHA_PORTATIL					INT,
			 K_PUNTO_VENTA_PORTATIL				INT,
			 D_MARCA_PORTATIL					VARCHAR(100),
			 MATRICULA_PORTATIL					VARCHAR(100),
			 MODELO_PORTATIL					VARCHAR(100),
			 KILOMETRAJE_PORTATIL				DECIMAL(19,4),
			 SERIE_PORTATIL						VARCHAR(100),
			 CAPACIDAD_PORTATIL					INT )

	INSERT INTO @VP_TBL_FICHA_PORTATIL
			(K_FICHA_PORTATIL, K_PUNTO_VENTA_PORTATIL, D_MARCA_PORTATIL, MATRICULA_PORTATIL, MODELO_PORTATIL,
			 KILOMETRAJE_PORTATIL, SERIE_PORTATIL, CAPACIDAD_PORTATIL )
	SELECT	K_FICHA_PORTATIL, FICHA_PORTATIL.K_PUNTO_VENTA, D_MARCA_UNIDAD, MATRICULA, MODELO,
			KILOMETRAJE, SERIE, CAPACIDAD
	FROM	FICHA_PORTATIL , PUNTO_VENTA, MARCA_UNIDAD
	WHERE	FICHA_PORTATIL.K_PUNTO_VENTA=PUNTO_VENTA.K_PUNTO_VENTA
	AND		MARCA_UNIDAD.K_MARCA_UNIDAD=FICHA_PORTATIL.K_MARCA
	...
	LEFT JOIN @VP_TBL_FICHA_ESTACION_CARBURACION AS EST
			ON EST.K_PUNTO_VENTA_ESTACION = PUNTO_VENTA.K_PUNTO_VENTA	
	LEFT JOIN @VP_TBL_FICHA_PORTATIL AS POR
			ON POR.K_PUNTO_VENTA_PORTATIL = PUNTO_VENTA.K_PUNTO_VENTA	
