...
AS
	...
	SELECT	@VP_K_EXISTE =	K_TIPO_LIQUIDACION
							FROM	TIPO_LIQUIDACION
							WHERE	K_TIPO_LIQUIDACION=@PP_K_TIPO_LIQUIDACION

	-- ===============================

	IF @VP_K_EXISTE IS NULL
		INSERT INTO TIPO_LIQUIDACION
			(	K_TIPO_LIQUIDACION,				D_TIPO_LIQUIDACION, 
				S_TIPO_LIQUIDACION,				O_TIPO_LIQUIDACION,
				C_TIPO_LIQUIDACION,
				L_TIPO_LIQUIDACION			)
		VALUES	
	...
	ELSE
		UPDATE	TIPO_LIQUIDACION
		SET		D_TIPO_LIQUIDACION	= @PP_D_TIPO_LIQUIDACION,	
				S_TIPO_LIQUIDACION	= @PP_S_TIPO_LIQUIDACION,			
				O_TIPO_LIQUIDACION	= @PP_O_TIPO_LIQUIDACION,
				C_TIPO_LIQUIDACION	= @PP_C_TIPO_LIQUIDACION,
				L_TIPO_LIQUIDACION	= @PP_L_TIPO_LIQUIDACION
		WHERE	K_TIPO_LIQUIDACION=@PP_K_TIPO_LIQUIDACION
...
EXECUTE [dbo].[PG_CI_TIPO_LIQUIDACION] 0, 0,  1, 'INICIAL',	'INI', 1, '', 1
EXECUTE [dbo].[PG_CI_TIPO_LIQUIDACION] 0, 0,  2, 'FINAL',	'FIN', 2, '', 1
GO
