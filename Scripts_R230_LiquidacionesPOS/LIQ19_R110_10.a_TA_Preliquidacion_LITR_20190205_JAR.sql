...
AS
	...
	SELECT	@VP_K_EXISTE =	K_TIPO_PUNTO_VENTA
							...
							WHERE	K_TIPO_PUNTO_VENTA=@PP_K_TIPO_PRELIQUIDACION_LTR
	...
	ELSE
		...
		SET		D_TIPO_PUNTO_VENTA	= @PP_D_TIPO_PRELIQUIDACION_LTR,	
				S_TIPO_PUNTO_VENTA	= @PP_S_TIPO_PRELIQUIDACION_LTR,			
				O_TIPO_PUNTO_VENTA	= @PP_O_TIPO_PRELIQUIDACION_LTR,
				C_TIPO_PUNTO_VENTA	= @PP_C_TIPO_PRELIQUIDACION_LTR,
				L_TIPO_PUNTO_VENTA	= @PP_L_TIPO_PRELIQUIDACION_LTR
		WHERE	K_TIPO_PUNTO_VENTA=@PP_K_TIPO_PRELIQUIDACION_LTR
