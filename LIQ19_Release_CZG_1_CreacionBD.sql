...
-- // MÓDULO:			BASE DE DATOS (CREAR VACÍA)
-- // OPERACIÓN:		LIBERACIÓN / BASE DE DATOS
-- //////////////////////////////////////////////////////////////
-- //////////////////////////////////////////////////////////////
-- //////////////////////////////////////////////////////////////
...
CREATE DATABASE [LIQ19_Liquidaciones_V9999_R0] ON  PRIMARY 
	(	NAME =		N'LIQ19_Liquidaciones_V0004_R0_DAT',	
		FILENAME =	N'D:\SQL_ServerDBs\LIQ19\LIQ19_Liquidaciones_V0004_R0_DAT.mdf', 
		SIZE = 6072KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB						)
 LOG ON 
	(	NAME =		N'LIQ19_Liquidaciones_V0004_R0_LOG',	
		FILENAME =	N'D:\SQL_ServerDBs\LIQ19\LIQ19_Liquidaciones_V0004_R0_LOG.ldf',  
