...
EXECUTE [dbo].[PG_CI_TIPO_RUTA] 0, 0,  1, 'ESTACION CARBURACION','EST', 1, '', 1, 1
EXECUTE [dbo].[PG_CI_TIPO_RUTA] 0, 0,  2, 'AUTOTANQUE',			 'AUT', 2, '', 1, 2
EXECUTE [dbo].[PG_CI_TIPO_RUTA] 0, 0,  3, 'CILINDRERA',			 'CIL', 3, '', 1, 1
GO
...
ALTER TABLE [dbo].[RUTA] ADD 
	CONSTRAINT [FK_RUTA_02]  
		FOREIGN KEY ([K_ESTATUS_RUTA]) 
		REFERENCES [dbo].[ESTATUS_RUTA] ([K_ESTATUS_RUTA]),
	CONSTRAINT [FK_PRECIO_03]  
		FOREIGN KEY ([K_TIPO_RUTA]) 
		REFERENCES [dbo].[TIPO_RUTA] ([K_TIPO_RUTA])
GO
